      ...
      <div class="carousel-inner">
        ...
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">Hard Work Pays Off</p>
              <button type="button" id="btn-confirm2" class="btn btn-start animated fadeInUpBig">Start Exam</button>
          </div>
        </div>
        ...
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            ...
            <button type="button" id="btn-confirm3" class="btn btn-start animated fadeInUpBig">Start Exam</button>
          </div>
        </div>
      </div>
