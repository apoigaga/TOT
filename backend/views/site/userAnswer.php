...
if(isset($_POST['radio']) && $_POST['radio'] != "")
{
	...
	{
		$_SEESION['answer_array'] = array($answer);
	}
	else
	{
...
else 
{
	...
	if(!in_array("1", $_SESSION['answer_array']))
	{
		...
		echo "Did you even read the questions? You scored $percent%.";
	...
	echo "Thanks for taking the quiz, Your scored is $percent%";
	unset($_SESSION['answer_array']);
	unset($_SESSION['qid_array']);
